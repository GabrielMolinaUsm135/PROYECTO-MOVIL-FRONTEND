...
class TabTeclado extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: const [
            ...
            SizedBox(width: 8),
            Text('TechStore Teclados', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20)),
          ],
        ),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('Teclados', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),

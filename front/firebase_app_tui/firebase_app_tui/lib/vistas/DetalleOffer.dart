...
class OfferView extends StatelessWidget {
  ...
  final num precio;
  final num precioOriginal;
  final String image;

  const OfferView({super.key, required this.id, required this.nombre, required this.descripcion, required this.precio, required this.precioOriginal, required this.image});
  ...
  Widget build(BuildContext context) {
    ...
    final formattedOriginal = '\$${_fPrecio.format(precioOriginal)}';

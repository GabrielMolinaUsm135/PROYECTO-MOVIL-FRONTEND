...
class TabMouse extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: const [
            ...
            SizedBox(width: 8),
            Text('TechStore Mouse', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20)),
          ],
        ),
      ),
      body: Padding(
